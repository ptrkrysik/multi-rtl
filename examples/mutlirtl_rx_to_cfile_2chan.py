...
# Generated: Sun May  8 18:22:58 2016
##################################################
...
class mutlirtl_rx_to_cfile_2chan(gr.top_block):
    ...
    def __init__(self, samp_rate=1e6, freq_corr=0, sync_freq=939e6, sync_gain_ch0=30, sync_gain_ch1=30, freq_ch1=939e6, freq_ch0=939e6, gain_ch1=30, fname_ch1="ch1.cfile", gain_ch0=30, nsamples=int(1e10), fname_ch0="ch0.cfile", ch1_id_string="1", ch0_id_string="0"):
        ...
        # Blocks
        ##################################################
        self.multi_rtl_source = multi_rtl.multi_rtl_source(sample_rate=samp_rate, num_channels=2, ppm=freq_corr, sync_center_freq=939.4e6, rtlsdr_id_strings= [ 
          ch0_id_string, 
          ch1_id_string, 
          "2", 
          "3", 
        ...
        self.multi_rtl_source.set_sync_gain(25, 0)
        ...
        self.multi_rtl_source.set_sync_gain(25, 1)
...
def main(top_block_cls=mutlirtl_rx_to_cfile_2chan, options=None):
    ...
    tb = top_block_cls(samp_rate=options.samp_rate, freq_corr=options.freq_corr, sync_freq=options.sync_freq, sync_gain_ch0=options.sync_gain_ch0, sync_gain_ch1=options.sync_gain_ch1, freq_ch1=options.freq_ch1, freq_ch0=options.freq_ch0, gain_ch1=options.gain_ch1, fname_ch1=options.fname_ch1, gain_ch0=options.gain_ch0, nsamples=options.nsamples, fname_ch0=options.fname_ch0, ch1_id_string=options.ch1_id_string, ch0_id_string=options.ch0_id_string)
    tb.start()
    tb.wait()
